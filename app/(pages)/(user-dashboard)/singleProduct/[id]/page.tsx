...
toast.success(data.content);
          ...
          <div className="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
            <div className="lg:col-span-5 lg:col-start-8">
              <div className="flex justify-between">
                <h1 id='product_title' className="text-xl font-medium text-gray-200">{product?.title}</h1>
                <p id='product_price' className="text-xl font-medium text-gray-200">{product?.price}</p>
              </div>
            </div>
              ...
              <div>
                ...
                <div>
                  ...
                  <fieldset aria-label="Choose a color" className="mt-2">
                    <div className={`bg-${product?.color.clrName}-500 rounded-full w-5 h-5 border border-${product?.color.clrName}-500`}></div>
                  </fieldset>
                </div>

                <div className="flex justify-between max-w-60 my-4 items-center">
  <label className="block mb-1 text-gray-500">Choose quantity:</label>
  <div className="relative flex items-center">
    ...
    <button
      onClick={() => {
        setSelectedQty((prevQty) => Math.min(prevQty + 1, product?.qty || 0));
      }}
      type="button"
      id="increment-button"
