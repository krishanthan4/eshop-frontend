      ...
      <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <form className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                      ...
                      <div>
                        <div className="flex justify-between">
                          <h3 className="text-sm">
                            <a href={product.href} className="font-medium text-gray-300 hover:text-gray-500">
                              {product.name}
                            </a>
                          </h3>
                        </div>
                        <div className="mt-1 flex text-sm">
                          ...
                          {product.size ? (
                            <p className="ml-4 border-l border-gray-700 pl-4 text-gray-400">{product.size}</p>
                          ) : null}
                        </div>
                        <p className="mt-1 text-sm font-medium text-gray-200">{product.price}</p>
                      </div>
          ...
          <section
            ...
            className="mt-16 bg-[#2b2c30] rounded-lg  px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8"
          >
            ...
            <dl className="mt-6 space-y-4">
              <div className="flex items-center justify-between">
                ...
                <dd className="text-sm font-medium text-gray-200">$99.00</dd>
              </div>
              ...
              <div className="flex items-center justify-between border-t border-gray-700 pt-4">
                ...
                <dd className="text-base font-medium text-gray-200">$112.32</dd>
              </div>
            </dl>
